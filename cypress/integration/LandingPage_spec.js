describe('LandingPage', () => {
  ...
  it('Should display tutorial carousel', () => {
    cy.get('.slides')
    .get(':nth-child(1) > img')
    .should('be.visible')
  })

  it('carousel right arrow should navigate forward through images', () => {
    cy.get('.next').click()
    .get(':nth-child(1) > img')
  ...
  it('carousel left arrow should navigate backwards through images', () => {
    cy.get('.prev').click()
    .get(':nth-child(1) > img')
    .should('not.have.class', 'active')
    .get(':nth-child(5) > img')
  ...
  it('carousel left arrow should navigate backwards through images', () => {
    cy.get('.slide-dots > :nth-child(3)').click()
    .get(':nth-child(1) > img')
    .should('not.have.class', 'active')
    .get(':nth-child(3) > img')
    .should('be.visible')
